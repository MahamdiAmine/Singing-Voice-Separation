...
if __name__ == '__main__':
    ...
    #     sys.exit(-1)
    input = './inputs/song.mp3'
    output_voice = './outputs/voice.mp3'
    output_music = './outputs/music.mp3'
    data, sr = librosa.load(input)
    E, A = singing_voice_separation(data, sr)
    librosa.output.write_wav(output_voice, E, sr)
    librosa.output.write_wav(output_music, A, sr)
